...
/** 渐变色填充 */
- (UIImage *)sb_imageWithGradientTintColor:(UIColor *)tintColor;
...
/** 文字转图片 */
+(UIImage *)imageFromText:(NSString *)string size:(CGSize)size font:(NSInteger)fontsize textColor:(UIColor *)textColor backColor:(UIColor *)backColor;
